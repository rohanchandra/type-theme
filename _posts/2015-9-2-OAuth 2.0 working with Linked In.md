...
<p>&nbsp;</p>
<p>See <a href="/docs/oauth2#permissions">Understanding
application permissions</a> and the <a href="/docs/best-practices#accesstokens">Best
practices guide</a> for additional information about scopes.<br></p></td><td>Optional</td></tr></tbody></table>
</div>
